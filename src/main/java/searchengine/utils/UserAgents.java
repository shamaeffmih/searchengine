...
public class UserAgents {
    private static final Map<String, String[]> userAgentsBootsMap = new HashMap<>();
    private static final String[] browsers = {"Sogou", "Google", "Yandex", "Mail.ru", "Rambler", "Yahoo", "MSN", "Bing"};

    static {
        userAgentsBootsMap.put("Sogou", new String[]{
        ...
        userAgentsBootsMap.put("Google", new String[]{
        ...
        userAgentsBootsMap.put("Yandex", new String[]{
        ...
        userAgentsBootsMap.put("Mail.ru", new String[]{
                "Mozilla/5.0 (compatible; Mail.RU_Bot/Fast/2.0)"
        });
        userAgentsBootsMap.put("Rambler", new String[]{
                "StackRambler/2.0 (MSIE incompatible)",
                "StackRambler/2.0"
        });
        userAgentsBootsMap.put("Yahoo", new String[]{
                "Mozilla/5.0 (compatible; Yahoo! Slurp; http://help.yahoo.com/help/us/ysearch/slurp)",
                "Mozilla/5.0 (compatible; Yahoo! Slurp/3.0; http://help.yahoo.com/help/us/ysearch/slurp)"
        });
        userAgentsBootsMap.put("MSN", new String[]{
                "msnbot/1.1 (+http://search.msn.com/msnbot.htm)",
                "msnbot-media/1.0 (+http://search.msn.com/msnbot.htm)",
                "msnbot-media/1.1 (+http://search.msn.com/msnbot.htm)",
                "msnbot-news (+http://search.msn.com/msnbot.htm)"
        });
        userAgentsBootsMap.put("Bing", new String[]{
    ...
    public static String getUserAgent() {
        ...
        String browser = browsers[rand];

        String[] userAgents = userAgentsBootsMap.get(browser);
        var a = (int) Math.floor(Math.random() * userAgents.length);
        return userAgents[a];
    }
}
